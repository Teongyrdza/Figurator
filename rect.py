...
class BoundingRect:
    ...
    def contains(self, other):
        return (self.x1 <= other.x1 <= self.x2) and (self.y1 <= other.y1 <= self.y2) and (self.x1 <= other.x2 <= self.x2) and (self.y1 <= other.y2 <= self.y2)
...
def within_x(co1: BoundingRect, co2: BoundingRect) -> bool:
    return (co2.x1 < co1.x1 < co2.x2) or (co2.x1 < co1.x2 < co2.x2) or (co1.x1 < co2.x1 < co1.x2) or (co1.x1 < co2.x2 < co1.x2)


def within_y(co1: BoundingRect, co2: BoundingRect) -> bool:
    return (co2.y1 < co1.y1 < co2.y2) or (co2.y1 < co1.y2 < co2.y2) or (co1.y1 < co2.y1 < co1.y2) or (co1.y1 < co2.y2 < co1.y2)
